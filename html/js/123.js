    ...
    predict = function (lastRequested, lastQuality, lastHTTPRequest, last_Bufferleveling) {//lastRequested==index
        ...
        if (past_Throughput.length == 0) {
           ...
           if (lastRequested < 6) {
                ...
                let pre1_avg= tmpDownloadTime/tmpSum;
           ...
           //bugout.log("last_index：  " + lastRequested +"  last:   " +last_Throughput+"  current_index:  "+lastRequested+"  predict:  "+initial_Bandwidthpredict);
           ...
           // console.log(" current_bufferlevel", current_bufferlevel);
            ...
            if (lastRequested < 6) {
               ...
               // console.log("pre2_avg",pre2_avg);
                ...
                if ( current_bufferleveling - (current_bufferlevel) > 2) {
            ...
            console.log("pre2_avg",pre2_avg);
            console.log("current_buffer",current_bufferlevel);
            console.log("current_buffering",current_bufferleveling);
            ...
            if(lastRequested>1) {
                for (var i = 0; i < 6; i++) {
                    initial_bandwidth[i] = [VIDEO_BIT_RATE[i] / 1000] * Playing_time / [current_bufferlevel - (current_bufferleveling - Playing_time)];
                ...
                /*          let loglog = get_best(initial_bandwidth[i], last_Bufferleveling, lastRequested, lastQuality);
                      ...
                      console.log("min_i",min_i);
                      predict_Throughput = initial_bandwidth[min_i];
                      if(min_i.length==0)
                           predict_Throughput=initial_bandwidth[0];
           ...
           // console.log("log_pre2",log_pre2);
            let current_index=last_index+1;
              bugout.log("last_index：  " + lastRequested +"  last:   " +last_Throughput*8+"  current_index:  "+current_index+"  predict:  "+ predict_Throughput*8+"  lastbuffer  "+last_Bufferleveling+"  predictbuffer:  "+current_bufferleveling+"  pre2_avg:  "+pre2_avg+"  final_difference:  "+final_difference+"  log_pre2:  "+log_pre2);
        //kalman
